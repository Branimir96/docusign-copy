...
>(({ className, checkClassName, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      'border-neutral-300 bg-white data-[state=checked]:border-[#1F4E78] data-[state=checked]:bg-[#1F4E78]',
      className,
    )}
    {...props}
  >
    <CheckboxPrimitive.Indicator
      className={cn('flex items-center justify-center text-white', checkClassName)}
    >
